 ...
 <div class="row"  >
     <div class="span8">
        <article>
            ...
            <div class="row "  >
              <div class="span8" v-for="(post,index) in posts" :key="index"  style="margin-bottom:10px">
                 ...
                 <p v-html="subStrWithHtml(post.content,300, '.....')">  </p>
 ...
 export default{
    name: "CategoryPost",
     ...
     methods:{
          ...
          let get_this = this
          axios.get("/get-category-posts/"+ this.$route.params.slug).then((response)=>{
              //response.data.category--- ekhane category namta hocce categoryController theke response ermaddhome pathano nam.So same name hoite hbe
                this.posts = response.data.posts;//using this command set the data of input field
          })
      }
     }
 }
